		...
		<div className="bg-white text-black min-h-screen p-4 sm:p-6">
			...
			<div className="relative max-w-6xl mx-auto">
				...
				<div className="text-center mb-10 sm:mb-12">
					<h1 className="text-3xl sm:text-5xl font-bold mb-4 sm:mb-6 text-black">
				...
				<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 mb-10 sm:mb-12">
					{/* Problems */}
					<div className="bg-white rounded-lg p-6 sm:p-8 border-2 border-black hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 backdrop-blur-sm">
						<div className="flex items-center mb-4 sm:mb-6">
							...
							<h3 className="text-xl sm:text-2xl font-bold text-black">Browse Problems</h3>
						</div>
						<p className="text-gray-600 mb-4 sm:mb-6 leading-relaxed">Explore and solve coding challenges</p>
						<button 
					...
					<div className="bg-white rounded-lg p-6 sm:p-8 border-2 border-black hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 backdrop-blur-sm">
						<div className="flex items-center mb-4 sm:mb-6">
							...
							<h3 className="text-xl sm:text-2xl font-bold text-black">Code Editor</h3>
						</div>
						<p className="text-gray-600 mb-4 sm:mb-6 leading-relaxed">Write and test your code</p>
						<button 
					...
					<div className="bg-white rounded-lg p-6 sm:p-8 border-2 border-black hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 backdrop-blur-sm">
						<div className="flex items-center mb-4 sm:mb-6">
							...
							<h3 className="text-xl sm:text-2xl font-bold text-black">Your Profile</h3>
						</div>
						<p className="text-gray-600 mb-4 sm:mb-6 leading-relaxed">View your stats and achievements</p>
						<button 
					...
					{(loggedInUser.accType === 'Problemsetter' || loggedInUser.accType === 'Admin') && (
						<>
							<div className="bg-black text-white rounded-lg p-6 sm:p-8 border-2 border-gray-300 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 backdrop-blur-sm">
								<div className="flex items-center mb-4 sm:mb-6">
									...
									<h3 className="text-xl sm:text-2xl font-bold">Create Problem</h3>
								</div>
								<p className="text-gray-300 mb-4 sm:mb-6 leading-relaxed">Design new coding challenges</p>
								<button 
							...
							<div className="bg-gray-900 text-white rounded-lg p-6 sm:p-8 border-2 border-gray-400 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 backdrop-blur-sm">
								<div className="flex items-center mb-4 sm:mb-6">
									<div className="w-12 h-12 bg-white rounded-lg flex items-center justify-center mr-4">
										<svg className="w-6 h-6 text-black" fill="none" stroke="currentColor" viewBox="0 0 24 24">
											<path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
									...
									<h3 className="text-xl sm:text-2xl font-bold">My Problems</h3>
								</div>
								<p className="text-gray-300 mb-4 sm:mb-6 leading-relaxed">Manage your created problems</p>
								<button 
				...
				{loggedInUser.accType === 'Problemsetter' && (
					<div className="bg-gray-50 rounded-lg p-6 sm:p-8 border-2 border-black backdrop-blur-sm">
						...
						<h3 className="text-lg sm:text-xl font-bold text-black">Problemsetter Features</h3>
					</div>
